...
pt1 = copy.deepcopy(pcd_demo[0])
pt2 = copy.deepcopy(pcd_demo[1])
pt3 = copy.deepcopy(pcd_demo[2])
pt4 = copy.deepcopy(pcd_demo[3])

## save 2 PC
# file_path_1 = '.\\ply\\' + 'test_1' + '.pcd'
# file_path_2 = '.\\ply\\' + 'test_2' + '.pcd'
# write_point_cloud(file_path_1, pt1)
# write_point_cloud(file_path_2, pt2)

pt2.transform(RT2)
pt3.transform(RT3)
pt4.transform(RT4)
draw_geometries([pt1+pt2+pt3+pt4])
